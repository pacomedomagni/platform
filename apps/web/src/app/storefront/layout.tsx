      ...
      <header className="sticky top-0 z-30 border-b border-slate-200/70 bg-white/80 backdrop-blur">
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/login" className="hidden items-center gap-2 text-sm font-medium text-slate-600 hover:text-slate-900 sm:flex">
            ...
            <Link href="/storefront/cart" className="relative rounded-full border border-slate-200 bg-white p-2 text-slate-600 shadow-sm hover:text-slate-900">
              <ShoppingCart className="h-4 w-4" />
              <span className="absolute -right-1 -top-1 h-4 w-4 rounded-full bg-amber-400 text-[10px] font-semibold text-slate-900 flex items-center justify-center">
                2
              </span>
            </Link>
          </div>
      ...
      <footer className="border-t border-slate-200/70 bg-white">
        <div className="mx-auto grid w-full max-w-7xl gap-8 px-6 py-12 md:grid-cols-[1.2fr_1fr_1fr_1fr]">
          ...
          <div className="space-y-3 text-sm text-slate-600">
            ...
            <Link href="/login" className="block hover:text-slate-900">Client login</Link>
